...
Cohesion: 0.03
Nodes (63): Database?, attemptCount, cancelReason, capturedAtMs, clearUserCaches, copyProofToQueue, _createSchema, _createTwoStageDeliveryTables (+55 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (57): abLenSq, abx, aby, apx, apy, ax, ay, bx (+49 more)
...
Cohesion: 0.04
Nodes (54): actualInAt, actualOutAt, bonusHeadline, bumperSubtitle, deliveriesCount, deliveryRules, distanceTodayMeters, driver (+46 more)
...
Cohesion: 0.05
Nodes (41): _appendCacheBuster, auth, authStateChanges, authStateChangesProvider, avatarObjectKey, avatarUpdatedAt, avatarUrl, _client (+33 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (37): accentOrange, AppColors, attendanceLegendBg, attendancePresentBg, attendancePresentBorder, bannerLavender, blueberry, bonusLavender (+29 more)
...
Cohesion: 0.06
Nodes (35): ../branding/app_branding_provider.dart, ChangeNotifier, ../../features/attendance/attendance_screen.dart, ../../features/auth/login_screen.dart, ../../features/blocked/blocked_screen.dart, ../../features/deliveries/active_delivery_screen.dart, ../../features/deliveries/add_delivery_screen.dart, ../../features/deliveries/deliveries_screen.dart (+27 more)
...
Cohesion: 0.06
Nodes (34): ../../../core/permissions/duty_permission_status.dart, required DutyReadinessCallback onContinue,
  DutyReadinessFlow, startDuty,, allRequiredOk, build, busy, _continue, _continuing (+26 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (34): Duration, AdaptiveLocationScheduler, apiValue, decodeRpcError, distanceTodayMeters, forceDeliverySample, fromJson, historyWritten (+26 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (34): ../../earnings/earnings_providers.dart, active, _bikeFraction, _BikeTrack, child, completed, _CompletedBadge, extraMore (+26 more)
...
Cohesion: 0.07
Nodes (29): adminApiBaseUrl, AppFlavor, Env, firebaseApiKey, firebaseAppId, firebaseIosAppId, firebaseIosBundleId, firebaseMessagingSenderId (+21 more)
...
Cohesion: 0.15
Nodes (7): Activity, Boolean, Int, Context, DutyOverlayController, View, WindowManager
...
Cohesion: 0.08
Nodes (26): ../../../core/branding/branding_logo.dart, notificationsUnreadCountProvider, badgeCount, build, driverName, _DutyToggle, hasDisplayableLogo, _height (+18 more)
...
Cohesion: 0.08
Nodes (23): ../auth/driver_access.dart, cancelDelivery, _client, code, completeDelivery, createDelivery, createPickup, _deliverySelect (+15 more)

### Community 58 - "Community 58"
Cohesion: 0.08
Nodes (23): Client, ConnectivityResult, _bootstrap, build, connectivity, consecutiveRpcFailures, copyWith, _httpClient (+15 more)

### Community 59 - "Community 59"
Cohesion: 0.08
Nodes (23): _brokenAndroidId, _cached, current, deviceId, DeviceIdentity, deviceIdentityProvider, DeviceIdentityService, deviceIdOnly (+15 more)
...
Cohesion: 0.10
Nodes (19): ../../features/duty/adaptive_location_scheduler.dart, _client, code, fetchTodayShift, fromJson, map, _mapPostgrest, message (+11 more)

### Community 75 - "Community 75"
Cohesion: 0.10
Nodes (19): _accentForPriority, _CenteredScrollView, child, _ChipLabel, color, diff, _EmptyState, _formatCategory (+11 more)

### Community 76 - "Community 76"
Cohesion: 0.11
Nodes (18): apkSha256, apkSizeBytes, apkUrl, AppRelease, _asInt, available, fromJson, hasUpdate (+10 more)

### Community 77 - "Community 77"
Cohesion: 0.11
Nodes (18): _apkFileName, _apkTargetFile, _authorizedGet, _client, code, downloadApk, evaluateUpdate, fetchActiveRelease (+10 more)

### Community 78 - "Community 78"
Cohesion: 0.11
Nodes (18): cash_stack.dart, HomeWeekStats, Route /earnings, build, build, child, createState, customValue (+10 more)

### Community 79 - "Community 79"
Cohesion: 0.11
Nodes (18): fromWidgetRef, _handleCustomPayload, handleDeepLink, handlePayload, hasUserVisibleAction, _invalidateDashboard, _isHomeRoute, _musallamPath (+10 more)
...
Cohesion: 0.11
Nodes (17): activeDevice, ActiveDeviceInfo, blocked, blockReason, DeviceHeartbeatResult, deviceId, deviceManufacturer, deviceModel (+9 more)
...
Cohesion: 0.12
Nodes (16): 1. The big picture, 2. Environment separation — THE critical rules, 3. Versioning rules (see also AGENTS.md), 4. Release signing (MDM + OTA) — required, 5. Standard publish procedure, 5a. Production release (forced/required example), 5b. Internal/testing release, 6. Manual publish (if release.sh can't be used) (+8 more)

### Community 92 - "Community 92"
Cohesion: 0.12
Nodes (16): actionRequired, description, DutyPermissionItem, DutyPermissionKind, DutyPermissionState, DutyReadinessReport, fixActionLabel, isOk (+8 more)
...
Cohesion: 0.12
Nodes (15): appSubtitle, defaults, hashCode, iconUrl, isSvgIcon, isSvgLogo, loginHint, logoUrl (+7 more)
...
Cohesion: 0.13
Nodes (14): addMonths, clampToMonth, day, formatDayNumber, generate, isSameLocalDay, la, lastDay (+6 more)
...
Cohesion: 0.15
Nodes (12): allowed, blocked, DriverAccessParser, DriverAccessStatus, _extractReasonFromText, looksBlocked, _readReason, reason (+4 more)
...
Cohesion: 0.17
Nodes (11): ../offline/offline_db.dart, required SecurityEventType eventType,
...
Cohesion: 0.20
Nodes (9): DayStatus, adherenceLabel, adherenceOnTime, AttendanceDayCell, build, dayNumber, hourLabel, status (+1 more)
...
Cohesion: 0.22
Nodes (8): allowedExtensions, allowedMimeTypes, _extension, maxBytes, mimeFromFilename, OrderProofConstraints, validateFile, validateMime

### Community 140 - "Community 140"
Cohesion: 0.25
Nodes (7): Add delivery + R2 proof, Branding & maintenance, Deploy Edge Function, Driver passcode login, Errors, Flow, Run the app

### Community 141 - "Community 141"
Cohesion: 0.25
Nodes (7): _channel, disableLock, DutyLockChannel, enableLock, hasOverlayPermission, isLocked, requestOverlayPermission

### Community 142 - "Community 142"
Cohesion: 0.29
Nodes (6): `driver_log_security_event`, `driver_release_device_session`, Pickup / completion RPC idempotency, Related docs, Server verification checklist (driver app client assumptions), Single-device session / `flush_grace_active`
...
Cohesion: 0.29
Nodes (7): notificationInboxProvider, build, NotificationsInboxScreen, _onForegroundMessage, Route /notifications, build, HomeNotificationsCard

### Community 149 - "Community 149"
Cohesion: 0.33
Nodes (5): AppLocalizations get, BuildContext, l10n, L10nContext, package:flutter/widgets.dart
